$(document).ready(function () {
    ...
    var table_data = $("#" + data_id + " .table").DataTable({
        'ajax': {
            ...
            'url': rootUrl + "partner/search-partner",
            'data': function (d) {
    ...
    $("#filter-button").click(function () {
        HQ.showLoading("#chart-click-content");
        $.ajax({
            type: "POST",
            url: rootUrl + "chart/list-link",
            data: $("#filter-form").serialize()
        }).done(function (msg) {
            HQ.offLoading("#chart-click-content");
            $("#chart-click-content").empty();
            eval(msg);
        }).error(function (err) {
            HQ.offLoading("#chart-click-content");
